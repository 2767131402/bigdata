package io.zhenglei.log.utils.ip;
...
public class TestIPSeek {
	...
	public static void main(String[] args) {
		...
		RegionInfo info = ipSeekerExt.analyticIp(null);
		System.out.println(info.getCity()+" "+info.getCountry()+" "+info.getProvince());
		System.out.println("");
		//p_url=http://172.16.0.150:8080/BIG_DATA_LOG2/demo.js
//		String url=URLDecoder.decode("p_url=http%3A%2F%2F172.16.0.150%3A8080%2FBIG_DATA_LOG2%2Fdemo4.jsp");
